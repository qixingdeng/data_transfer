...
public class XMLUtil {
	 ...
	 */
	public static boolean validateXMLByXSD(String xmlStr,String xsdStr, StringBuilder msgerror) {
		boolean sign = false ;
		try {
			// 创建默认的XML错误处理器
			...
			Document xmlDocument = (Document) xmlReader.read(fileinputStream);
			...
			if (errorHandler.getErrors().hasContent()) {
				...
				msgerror.append(errorHandler.getErrors().asXML());
				sign = false ;
			} else {
