...
@XmlType(name = "CommandResponse", propOrder = { "transaction" })
public class CommandResponse {

	protected CommandResponse.Transaction transaction;

	/**
	 * Gets the value of the transaction property.
	 * 
	 * @return possible object is {@link CommandResponse.Transaction }
	 * 
	 */
	public CommandResponse.Transaction getTransaction() {
		return transaction;
	}
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link CommandResponse.Transaction }
	 * 
	 */
	public void setTransaction(CommandResponse.Transaction value) {
