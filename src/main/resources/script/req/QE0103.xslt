  ...
  <xsl:template match="/">
    ...
    <selectParamRoot>
       <column>
        ...
        <column>oldBlacklistId</column>
        <column>validStartDate</column>
        <column>validEndDate</column>
        <column>staffQcNo</column>
        <column>reason</column>
        <column>recordPersonName</column>
        <column>recordTime</column>
        <column>ownOrg</column>
        <column>ownDep</column>
      </column>
      <xsl:if test="$idCard!=''">
        <wheres>
      ...
      <mappername>DwBlacklistStaff</mappername>
      <tablename>DW_BLACKLIST_STAFF</tablename>
      <pageInfo>
        <xsl:if test="$limit!=''">
          <limit>
